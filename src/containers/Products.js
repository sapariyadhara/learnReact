...
const myData = [
  ...
  },
  {
    ...
    features:
      "Made of wood n 2.5 x 2.5 inch cuben6.75 inch tall n Recommended for Ages 3+",
    price: "9.99",
    keywords:
  ...
  },
  {
    ...
    features:
      "Pack contains two sticker sheets n Each Sheet has different emojis n Decal dimensions should fit in a maximum sheet size of 12 3/4 x 17 1/2 inch.",
    price: "4.99",
    keywords:
  ...
  },
  {
    ...
    features:
      "<p>Pack of 9 includes:n3 Waze Mood Happy decals n 3 Waze Mood Original decals n 3 Waze Mood Ninja decals",
    price: "16.99",
    keywords:
  ...
  },
  {
    ...
    features:
      "Heavy weight brushed twill n Adjustable velcro closuren One size fits all</p>",
    price: "10.99",
    keywords:
...
class Products extends Component {
  ...
  handleMobile = () => {
    let mData = myData.filter((v, i) => v.category === 'Mobile')
    this.setState({
      myFData: mData,
      selected: 'Mobile'
    })
  ...
  handlePc = () => {
    console.log("pc");
    let pData = myData.filter((v, i) => v.category === 'Pc')
  ...
  handleLaptop = () => {
    console.log("leptop");
    let lData = myData.filter((v, i) => v.category === 'Laptop')
    this.setState({
      myFData: lData,
      selected: 'Laptop'
    })
      ...
      <div>
        ...
        <Container >
          <div className="text-center">
            <Button
              style={{ fontSize: '20px' }}
              outline={this.state.selected === 'Mobile' ? false : true}
              onClick={this.handleMobile}>Mobile</Button> {'   '}

            <Button style={{ fontSize: '20px' }}
              outline={this.state.selected === 'Pc' ? false : true}
              onClick={this.handlePc}>Pc</Button>{'   '}
            <Button style={{ fontSize: '20px' }}
              outline={this.state.selected === 'Laptop' ? false : true}
              onClick={this.handleLaptop}>Laptop</Button>{'   '}
          </div>
          <Row>


            {this.state.myFData.map((v) => {
              return (
                ...
                <Col sm="3">
                  ...
                  >
                    ...
                    <CardBody style={{ fontSize: '15px'}}>
                      ...
                      <Button style={{ fontSize: '15px'}}>Click</Button>
                    </CardBody>
                  </Card>
                </Col>
